 ...
 * @param {{apis: string[], definition: {components: {securitySchemes: {bearerAuth: {bearerFormat: string, scheme: string, type: string}}}, security: [{bearerAuth: *[]}], openapi: string, info: {title: string, version: string}}}} options - Configuration options
